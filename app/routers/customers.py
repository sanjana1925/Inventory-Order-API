...
from app.schemas import CustomerCreate, CustomerLoginRequest, CustomerOut, CustomerSignup, CustomerUpdate
...
@router.post("/signup", response_model=CustomerOut, status_code=201)
